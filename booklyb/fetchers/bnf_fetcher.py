...
class BNFFetcher:
    ...
    TITLE_INFORMATIONS = "title_and_statement_of_responsibility"
    SUMMARY = "summary_or_abstract"
    GENERAL_DATA = "general_processing_data"
    PUBLISHER_DATA = "publisher_data"
    LANGUAGE = "language"
    SET = "set"

    TITLE_LABEL = "title_proper"
    NAME_OF_PART = "name_of_part"
    NUMBER_OF_PART = "number_of_part"
    AUTHOR_NAME = "first_statement_of_responsibility"
    ...
    PUBLISHER_NAME = "name_of_publisher"
    ...
    def fetch(self, isbn):
        ...
        book_data = fetch_book_information(isbn, fetcher_name=self.__class__.__name__)
